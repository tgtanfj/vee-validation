...
<template>
  <div
    role="status"
    class="h-full w-full animate-pulse space-y-12 divide-y divide-gray-200 rounded border border-gray-200 p-4 shadow dark:divide-gray-700 dark:border-gray-700"
  >
